...
.Pasos
. Elimina el sistema Cloud Volumes ONTAP. Consulta link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Eliminación de sistemas Cloud Volumes ONTAP"].
