...
+
Los permisos se proporcionan en el https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["Los permisos de la cuenta de servicio por defecto"^] , pero es posible que no se aplique si utiliza un proyecto alternativo para el Servicio de administración de claves en la nube.
...
. Usa el parámetro "gcpEncryption" con tu solicitud de API al crear un sistema.
+
*Ejemplo*
...
Consulta la  https://docs.netapp.com/us-en/console-automation/index.html["Documentación de automatización de la NetApp Console"^] para obtener más detalles sobre el uso del parámetro "GcpEncryption".
