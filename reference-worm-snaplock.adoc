...
* Para obtener más información sobre WORM, consultelink:concept-worm.html["Obtenga más información sobre el almacenamiento WORM en Cloud Volumes ONTAP"] .
* Para obtener información sobre la carga de los volúmenes SnapLock , consultelink:concept-licensing-charging.html["Licencias y tarificación en Cloud Volumes ONTAP"] .
