...
NOTE: NetApp ha restringido la compra, la ampliación y la renovación de las licencias BYOL, y ha limitado su disponibilidad en casos específicos, como en las implementaciones en modo privado. Para más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidad restringida de licencias BYOL para Cloud Volumes ONTAP"^].
...
* *Suscripciones del Marketplace/contrato anual*: Un contrato anual del Marketplace de tu proveedor de servicios en la nube. Las implementaciones en modo privado no admiten suscripciones del Marketplace.
...
* Si tienes una licencia BYOL y un contrato anual de un marketplace, tu consumo y los excedentes se cobran según la preferencia de facturación que hayas establecido. Para entender cómo se te cobra, consulta link:concept-licensing-charging.html#billing-preferences-and-overages["Preferencias de facturación y excedentes"].
* Sólo se admiten sistemas de nodo único con BYOL en las regiones de China. Las implementaciones en la región de China están exentas de las restricciones de licencia BYOL.
...
Para obtener más información sobre los precios, ve a la link:https://www.netapp.com/pricing/["Sitio web de precios de NetApp"^].
...
Con las licencias basadas en capacidad, el número máximo de sistemas Cloud Volumes ONTAP está limitado a 24 por organización de NetApp Console. Un _sistema_ es un par Cloud Volumes ONTAP HA, un sistema Cloud Volumes ONTAP de un solo nodo o cualquier instancia de VM de almacenamiento adicional que crees. La instancia de VM de almacenamiento predeterminada no cuenta para el límite. Este límite se aplica a todos los modelos de licencia.
...
+
Este sistema cuenta como dos sistemas: uno para el sistema de nodo único y uno para la VM de almacenamiento adicional.
...
Para obtener información sobre la facturación de las licencias de Essentials, consulta <<Paquetes esenciales>>.
...
* link:concept-licensing.html["Licencias para Cloud Volumes ONTAP"]
* link:task-manage-capacity-licenses.html["Administrar licencias basadas en capacidad para Cloud Volumes ONTAP"]
* link:task-manage-node-licenses.html["Gestiona las licencias por nodo"]
* link:task-convert-node-capacity.html["Convertir una licencia basada en nodos a una licencia basada en capacidad"]
* link:task-manage-keystone.html["Administrar suscripciones de Keystone"]
