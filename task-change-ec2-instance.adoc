...
.Referencia
Para consultar la lista de tipos de instancias compatibles en AWS, visita link:reference-configs-aws.html#supported-ec2-compute["Instancias EC2 compatibles"].
