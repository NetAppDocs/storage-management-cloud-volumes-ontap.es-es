...
* Se ofrece una licencia gratuita de Cloud Volumes ONTAP para una capacidad aprovisionada de hasta 500 GiB, sin soporte de NetApp y sin fecha de caducidad. La capacidad que supere los 500 GiB requiere una licencia válida y puede conllevar cargos. Para acceder a la experiencia completa de Cloud Volumes ONTAP y a las capacidades avanzadas de gestión, conecta tu sistema Cloud Volumes ONTAP a la consola. La detección y gestión a través de la consola requieren una suscripción válida de Azure Marketplace asociada a tu cuenta de la consola.
...
.Antes de empezar
* Si tienes previsto detectar y gestionar el sistema implementado en la Console, asegúrate de que la cuenta de la Console esté asociada a una suscripción válida de Azure Marketplace. La detección del sistema en la Console requiere una suscripción válida.
