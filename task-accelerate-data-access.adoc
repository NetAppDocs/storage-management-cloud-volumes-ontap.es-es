...
NetApp Console te permite gestionar los volúmenes de FlexCache con el link:https://docs.netapp.com/us-en/console-volume-caching/index.html["NetApp almacenamiento en caché de volúmenes"^].
