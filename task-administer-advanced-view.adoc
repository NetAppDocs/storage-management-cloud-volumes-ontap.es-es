...
* Gestión del almacenamiento de objetos ONTAP S3: las capacidades de gestión del almacenamiento ONTAP S3 en Cloud Volumes ONTAP solo están disponibles en System Manager y no en NetApp Console.
...
. Haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] del agente de consola que necesites y selecciona *Editar agente de consola*.
...
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html["Descubre cómo administrar clústeres con ONTAP System Manager"^]
