...
+
--
La consola de NetApp crea un único bucket S3 para cada sistema y lo denomina fabric-pool-_cluster unique identifier_.  No se crea un bucket S3 diferente para cada volumen.
...
* Clase de almacenamiento: Estándar
* Acceso público: Sujeto a ACL de objeto
