...
Si no tienes una https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Agente de consola"^] Aún así, es necesario crear uno. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html["Aprenda a crear un agente de consola en Google Cloud"^]
...
[role="quick-margin-para"]
https://cloud.google.com/apis/docs/getting-started#enabling_apis["Habilita las API de Google Cloud en tu proyecto"^]. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html#step-5-enable-google-cloud-apis["Estas APIs"^], que puede que ya hayas habilitado como parte de crear el agente de la Console, son necesarios para implementar Cloud Volumes ONTAP en Google Cloud.
