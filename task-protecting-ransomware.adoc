...
Además de las protecciones relacionadas con las extensiones de archivo que ofrece la  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html#protection-from-common-ransomware-file-extensions["configuración de protección contra ransomware"], la función ARP utiliza el análisis de cargas de trabajo para alertar al usuario sobre posibles ataques basándose en la “actividad anómala” detectada. Tanto la configuración de protección contra ransomware como la función ARP pueden usarse juntas para una protección integral contra ransomware.
