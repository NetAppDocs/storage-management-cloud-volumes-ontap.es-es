...
+
Omita la selección de configuraciones de eficiencia de almacenamiento al crear un volumen desde la consola de NetApp , o cree un volumen y luego http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/GUID-8508A4CB-DB43-4D0D-97EB-859F58B29054.html["deshabilitar la compresión de datos mediante la CLI"^] .
