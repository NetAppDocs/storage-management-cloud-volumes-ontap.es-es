...
Para obtener información sobre cómo ejecutar llamadas a la API de Cloud Volumes ONTAP, consulta https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["Su primera llamada a la API"^].
...
En función de tu configuración y tipo de licencia, puedes crear varias máquinas virtuales de almacenamiento en un sistema de nodo único o en una configuración de alta disponibilidad (HA) usando las API para la NetApp Console.
...
.Antes de empezar
El agente de Console necesita permisos específicos para crear máquinas virtuales de almacenamiento para Cloud Volumes ONTAP. Los permisos necesarios se incluyen en https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["las políticas proporcionadas por NetApp"^].
...
== Administra máquinas virtuales de almacenamiento en sistemas de nodo único y pares de alta disponibilidad
...
.Antes de empezar
El agente de Console necesita permisos específicos para gestionar máquinas virtuales de almacenamiento de Cloud Volumes ONTAP. Los permisos necesarios se incluyen en https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["las políticas proporcionadas por NetApp"^].
