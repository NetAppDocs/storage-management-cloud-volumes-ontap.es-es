...
[role="lead"]
Existen varios modelos de licencia disponibles para Cloud Volumes ONTAP. Cada opción te permite elegir un modelo de consumo que se adapte a tus necesidades.

Tienes opciones para comprar o renovar tus licencias y suscripciones desde los marketplaces en la nube o a través de NetApp (bring your own license (BYOL)). El marketplace te ofrece suscripciones anuales y opciones de pago por uso (PAYGO). Para más información, consulta link:concept-license-management.html["Obtenga más información sobre las licencias basadas en capacidad para Cloud Volumes ONTAP"].

Las licencias BYOL se pueden adquirir en NetApp y se pueden utilizar con cualquier proveedor de nube. Para obtener más información sobre la disponibilidad de las licencias BYOL, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidad restringida de licencias BYOL para Cloud Volumes ONTAP"^].
...
Los nuevos clientes pueden optar por pagar mediante suscripciones anuales basadas en la capacidad en el marketplace o mediante suscripciones Keystone. Algunas implementaciones, como las que se realizan en modo privado, también cuentan con licencias BYOL de la generación anterior basadas en nodos.

Licencias basadas en capacidad:: Pague por varios sistemas Cloud Volumes ONTAP en su cuenta de NetApp según la capacidad aprovisionada. Incluye la posibilidad de comprar servicios de datos en la nube complementarios. Para obtener más información sobre los modelos de consumo u opciones de compra en licencias basadas en capacidad, consultelink:concept-licensing-charging.html["Obtenga más información sobre las licencias basadas en capacidad"] .
...
* link:reference-configs-azure.html["Configuraciones admitidas en Azure"]
...
* link:reference-configs-gcp.html["Configuraciones compatibles en Google Cloud"^]
...
NOTE: Para utilizar Backup and Recovery es necesaria una suscripción de pago por uso (PAYGO); sin embargo, el uso de este servicio no conlleva ningún coste. Para obtener más información sobre cómo configurar las licencias de Backup and Recovery, consulta https://docs.netapp.com/us-en/data-services-backup-recovery/task-licensing-cloud-backup.html["Configurar licencias para copias de seguridad y recuperación"^].
...
https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap["Obtenga más información sobre los agentes de consola"^].


NOTE: NetApp ha restringido la adquisición, la ampliación y la renovación de las licencias BYOL. Para obtener más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidad restringida de licencias BYOL para Cloud Volumes ONTAPP"^].
...
Las suscripciones Keystone se admiten con pares de HA. Esta opción de licencia no es compatible con sistemas de nodo único en este momento.
...
NOTE: Implementaciones en modo privado de Cloud Volumes ONTAP en privado.
...
|===
.Excepciones
NetApp reconoce que determinadas situaciones requieren una consideración especial, como las implementaciones de Cloud Volumes ONTAP en AWS en la región de China, y que la EOA y la EOS de las licencias basadas en nodos podrían no aplicarse a los siguientes casos:
...
* link:concept-licensing-charging.html["Obtenga más información sobre las licencias basadas en capacidad"]
