...
* link:link:reference-configs-azure.html["Configuraciones admitidas en Azure"]
...
* link:link:reference-configs-gcp.html["Configuraciones compatibles en Google Cloud"^]
