...
| Editar proyecto  a| 
Selecciona el proyecto donde quieres que Cloud Volumes ONTAP resida.
...
. *Modelos de implementación de HA*: elige varias zonas (recomendado) o una sola zona para la configuración de HA. Luego selecciona una región y una zona.
+
