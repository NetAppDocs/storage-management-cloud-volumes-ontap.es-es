...
+
Conoce más sobre https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html#flash-cache-support["Flash Cache"^] y link:concept-write-speed.html["velocidad de escritura"].
