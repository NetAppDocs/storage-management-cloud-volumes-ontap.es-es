...
La herramienta de transición está disponible en el sitio de soporte de NetApp y crea los siguientes artefactos:
...
** Asegúrate de haber completado las configuraciones de red y creado el grupo de trabajadores para las implementaciones en modo privado. Consulta link:reference-networking-gcp.html#infrastructure-manager-configuration-in-private-mode-or-protected-environments["Configuración de Infrastructure Manager para implementaciones en modo privado"].
