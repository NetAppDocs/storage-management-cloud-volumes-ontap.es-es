...
---
= Implementa Cloud Volumes ONTAP usando opciones avanzadas en AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Deberías tener un https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["Agente de consola asociado con su sistema"^].
...
. Si se te solicita, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["crear un agente de consola"^].
...
| Editar credenciales | Selecciona las credenciales de AWS asociadas a la cuenta donde quieres implementar este sistema. También puedes asociar la suscripción de AWS marketplace que quieres usar con este sistema Cloud Volumes ONTAP. Haz clic en *Add Subscription* para asociar las credenciales seleccionadas con una nueva suscripción de AWS marketplace. La suscripción puede ser por un contrato anual o para pagar Cloud Volumes ONTAP por hora. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Descubra cómo agregar credenciales de AWS adicionales a la NetApp Console"^]. 
|===
+
...
. *Ubicación y conectividad*: Introduce la información de red que has anotado en https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information["Hoja de trabajo de AWS"^].
+
...
| Editar credenciales | Elige las credenciales de AWS y la suscripción de AWS Marketplace que quieres usar con este sistema Cloud Volumes ONTAP. Haz clic en *Add Subscription* para asociar las credenciales seleccionadas con una nueva suscripción de AWS Marketplace. La suscripción puede ser para un contrato anual o para pagar Cloud Volumes ONTAP por hora. Si compraste una licencia directamente de NetApp (bring your own license (BYOL)), entonces no se requiere una suscripción de AWS. NetApp ha restringido la compra, extensión y renovación de licencias BYOL. Para más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilidad restringida de licencias BYOL para Cloud Volumes ONTAP"^]. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Aprenda a agregar credenciales de AWS adicionales a la consola"^]. 
|===
+
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["Obtenga más información sobre la NetApp Data Classification"^]
** https://docs.netapp.com/us-en/data-services-backup-recovery/task-backup-to-s3.html["Obtenga más información sobre copias de seguridad y recuperación"^]
+
...
. *Perfil de uso, tipo de disco y política de niveles*: elija si desea habilitar las funciones de eficiencia de almacenamiento y editar la política de niveles de volumen, si es necesario.
+
Para más información, consulta link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#choose-a-volume-usage-profile["Elija un perfil de uso de volumen"^] y link:concept-data-tiering.html["Descripción general de la clasificación de datos"^].
