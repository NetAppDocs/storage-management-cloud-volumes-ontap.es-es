...
summary: Descubre las nuevas funciones y mejoras en la gestión de Cloud Volumes ONTAP. 
---
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html#conversion-in-a-private-mode-deployment["Conversión en una implementación en modo privado"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-perf-params-azure.html["Administrar el rendimiento de los discos SSD v2 Premium para Cloud Volumes ONTAP en Azure"^].
...
Para más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-aws.html["Implemente Cloud Volumes ONTAP en AWS mediante una implementación rápida"^].
...
Para obtener información sobre los paquetes de licencias, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Licencias para Cloud Volumes ONTAP"^].

Para obtener información sobre cómo cambiar a otro método de recarga, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["Gestionar licencias basadas en capacidad"^].
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-aws.html#network-configurations-to-support-connector-proxy-servers["Configuraciones de red para soportar el proxy del conector en AWS"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/azure/reference-networking-azure.html#network-configurations-to-support-connector["Configuraciones de red para admitir el proxy del conector en Azure"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#network-configurations-to-support-connector-proxy["Configuraciones de red para admitir el proxy del conector en Google Cloud"^]
...
Para obtener más información sobre las implementaciones en modo privado, consulta https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#restricted-mode["Obtenga más información sobre los modos de implementación de BlueXP"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-cvo-azure-mktplc.html["Implementar Cloud Volumes ONTAP desde Azure Marketplace"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html["Administrar máquinas virtuales de almacenamiento que brindan servicio de datos para Cloud Volumes ONTAP en Google Cloud"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-azure.html["Administrar máquinas virtuales de almacenamiento que brindan servicio de datos para Cloud Volumes ONTAP en Azure"^]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-azure-mktplace-direct.html["Obtenga información sobre las opciones de implementación de Cloud Volumes ONTAP en Azure"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-cvo-azure-mktplc.html["Implementar Cloud Volumes ONTAP desde Azure Marketplace"^]
...
link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-administer-advanced-view.html["Administrar Cloud Volumes ONTAP mediante el Administrador del sistema"^].
...
link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["Administrar licencias basadas en capacidad"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#end-of-availability-of-node-based-licenses["Fin de la disponibilidad de las licencias basadas en nodos"^] https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html["Convertir una licencia basada en nodos de Cloud Volumes ONTAP a una licencia basada en capacidad"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-data-tiering.html#data-tiering-in-azure["Organización de datos en niveles en Azure"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-azure.html#security-group-rules["Reglas del grupo de seguridad"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html#enabling-worm-on-a-cloud-volumes-ontap-working-environment["Habilitación de WORM en un entorno de trabajo de Cloud Volumes ONTAP"^]
...
Para obtener más información sobre AWS Local Zones con implementaciones de alta disponibilidad (HA), consulta link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones["Zonas locales de AWS"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-updating-ontap-cloud.html#upgrade-from-console-notifications["Actualizar el software Cloud Volumes ONTAP"]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html["Habilite las soluciones de protección contra ransomware de NetApp para Cloud Volumes ONTAP"]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["Almacenamiento WORM"]
...
* La suscripción está registrada para la función de Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD`. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-saz-feature.html["Descubre cómo habilitar VMOrchestratorZonalMultiFD para zonas de disponibilidad únicas"^].
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha-azure.html["Conoce los pares de alta disponibilidad en Azure"^].
...
Para obtener más información sobre AWS Local Zones con implementaciones HA, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones["Zonas locales de AWS"^].
...
Si así lo exigen tus políticas de seguridad, puedes configurar tus instancias de EC2 para que utilicen IMDSv2. Para obtener instrucciones, consulta https://docs.netapp.com/us-en/console-setup-admin/task-require-imdsv2.html["Documentación de configuración y administración de BlueXP para gestionar conectores existentes"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-updating-ontap-cloud.html#patch-releases["Actualizar Cloud Volumes ONTAP"^]
...
Para obtener más información sobre los informes de uso, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html#download-usage-reports["Descargar informes de uso"^].
...
Para obtener más información sobre ARP con Cloud Volumes ONTAP, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html#autonomous-ransomware-protection["Protección autónoma contra ransomware"^].
...
Para más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["Administrar licencias basadas en capacidad"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["Aprenda a ver la capacidad consumida en su cuenta"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-volumes.html["Obtenga más información sobre cómo visualizar los volúmenes FlexGroup creados."^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-encrypting-volumes.html["Aprenda a cifrar volúmenes con las soluciones de cifrado de NetApp"^].
...
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-private-mode.html["Instale el conector en una ubicación sin acceso a Internet"^]
* https://docs.netapp.com/us-en/console-setup-admin/task-logging-in.html["Acceda a la consola BlueXP en el Conector"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#manage-byol-licenses["Agregar una licencia no asignada"^]
...
Para obtener información detallada sobre cómo configurar el parámetro de creación de grupos de ubicación, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-configure-placement-group-failure-aws.html#overview["Configurar la creación de grupos de ubicación para AWS HA Single AZ"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html#provide-details-about-your-azure-private-dns["Proporcione detalles sobre su DNS privado de Azure"^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["Obtenga más información sobre el almacenamiento WORM."^]
...
Consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Licencias de Cloud Volumes ONTAP"^].
...
Para obtener más información sobre las licencias de funciones de ONTAP que se instalan automáticamente con Cloud Volumes ONTAP, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-default-configs.html["Configuración predeterminada para Cloud Volumes ONTAP"^].
...
Para más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-moving-resource-groups-azure.html["Mover grupos de recursos"].
...
Para obtener más información sobre esta nueva funcionalidad, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html["Configurar Cloud Volumes ONTAP para usar una clave administrada por el cliente en Azure"].
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html["Aprenda a cambiar los métodos de carga"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Obtenga más información sobre estos paquetes de licencias"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html["Obtenga más información sobre la compatibilidad con Elastic Volumes en AWS"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-administer-advanced-view.html["Obtenga más información sobre la Vista avanzada"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html["Obtenga más información sobre la compatibilidad con Elastic Volumes"].
...
"ec2:ModifyVolume",
----
Asegúrate de conceder estos permisos a cada conjunto de credenciales de AWS que hayas añadido a BlueXP. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["Consulte la última política de conectores para AWS"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-aws-shared-vpc.html["Aprenda a implementar un par HA en una subred compartida"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html["Obtenga más información sobre las conexiones de Azure Private Link con Cloud Volumes ONTAP"].
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html["Aprenda a crear máquinas virtuales de almacenamiento que brindan servicio de datos para Cloud Volumes ONTAP en Google Cloud"]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Obtenga más información sobre las licencias"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-storage-class-for-tiered-data["Aprenda a cambiar la clase de almacenamiento para datos en niveles"].
...
Aún puedes conectarte a System Manager introduciendo la dirección IP de gestión del clúster en un navegador web que tenga conexión al sistema Cloud Volumes ONTAP. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connecting-to-otc.html["Obtenga más información sobre cómo conectarse al Administrador del sistema"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-create-volumes.html["Aprenda a crear volúmenes en un agregado específico"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Obtenga más información sobre las opciones de licencia para Cloud Volumes ONTAP"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#exchange-unassigned-node-based-licenses["Aprenda a intercambiar licencias basadas en nodos no asignados"].
...
Si usas un  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["licencia basada en capacidad"^] para Cloud Volumes ONTAP, ya no se te cobra por la capacidad utilizada por los volúmenes FlexClone.
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-keystone.html["Descubra cómo comenzar a utilizar las suscripciones Keystone en BlueXP"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html["Obtenga más información sobre estos pasos"].
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Obtenga más información sobre estas opciones de licencia"].
...
El almacenamiento «Write Once, Read Many» (WORM) ya no está en vista previa y ahora está disponible para uso general con Cloud Volumes ONTAP. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html["Obtenga más información sobre el almacenamiento WORM"].
...
----
Asegúrate de conceder estos permisos a cada juego de credenciales de Azure que hayas añadido a BlueXP. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Ver la última política de conectores para Azure"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html["Obtenga más información sobre el uso de Azure Private Link con Cloud Volumes ONTAP"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-cooling-period-for-the-auto-tiering-policy["Aprenda a ajustar el período mínimo de enfriamiento."]
...
Ten en cuenta que un conector necesita un nuevo permiso para eliminar instantáneas de Azure. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Ver la última política de conectores para Azure"^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html["Dimensione su sistema en AWS"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-getting-started-aws-c2s.html["Implementar Cloud Volumes ONTAP en AWS Secret Cloud o AWS Top Secret Cloud"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-setting-up-kms.html["Obtenga más información sobre cómo configurar AWS KMS con Cloud Volumes ONTAP"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#requirements-for-cloud-volumes-ontap["Obtenga más información sobre los requisitos de dirección IP en Google Cloud"].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html["Obtenga más información sobre los requisitos de red de Google Cloud"].
