...
* Al crear un volumen iSCSI, la Console crea automáticamente un LUN por ti. Lo hemos simplificado creando solo un LUN por volumen, así que no tienes que gestionarlo. Después de crear el volumen, link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connect-lun.html["Utilice el IQN para conectarse al LUN desde sus hosts"^].
...
.Agregado específico
--
.. En la pestaña *Agregados*, ve al agregado que necesites y haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"].
...
+
*** link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#size-your-system-in-aws["Dimensionar su sistema en AWS"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionar su sistema en Azure"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-gcp.html#size-your-system-in-gcp["Dimensionar su sistema en Google Cloud"^]
