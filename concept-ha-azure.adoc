...
image:diagram_ha_azure.png["Una imagen conceptual que muestra un balanceador de carga que administra el tráfico entrante desde la consola de NetApp y los clientes, dos nodos de Cloud Volumes ONTAP en un VMSS Flex, discos SSD para datos de arranque y Page Blobs para datos de clientes."]

Tenga en cuenta lo siguiente acerca de los componentes de Azure que la consola de NetApp implementa para usted:
