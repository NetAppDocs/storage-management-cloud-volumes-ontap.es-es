...
.Pasos
. Selecciona la vista «System Manager» para cambiar el tamaño de un volumen a través de ONTAP System Manager. Consulta link:task-administer-advanced-view.html#get-started-with-system-manager["Comience a utilizar el Administrador del sistema"].
...
TIP: La consola muestra estos mensajes de «Acción requerida» cuando un agregado ha alcanzado el 90 % de su capacidad utilizada. Si el data tiering está habilitado, los mensajes se muestran cuando un agregado ha alcanzado el 80 % de su capacidad utilizada. De forma predeterminada, se reserva un 10 % de espacio libre para el data tiering. link:task-tiering.html#change-the-free-space-ratio-for-data-tiering["Obtenga más información sobre la relación de espacio libre para la clasificación de datos"^].
...
.. En la ficha de agregado, haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] y luego haz clic en *Ver detalles del agregado*.
...
+
Para más información, consulta link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["Replicación de datos entre sistemas"^].
...
+
Para más información, consulta link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html#managing-data-replication-schedules-and-relationships["Gestión de relaciones y programas de replicación de datos"^].
...
+
.. En el sistema Cloud Volumes ONTAP , haga clic en la *pestaña Agregados*.
.. En el bloque correspondiente, haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] y luego en *Ver detalles del bloque* para consultar la capacidad disponible (tamaño asignado menos la capacidad utilizada del bloque).
+
...
+
.. Selecciona el agregado, luego haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] > *Add Disks*.
