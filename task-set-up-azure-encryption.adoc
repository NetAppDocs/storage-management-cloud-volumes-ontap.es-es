...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Ver la lista más reciente de permisos"^]

.Pasos
. Obtén la lista de almacenes de claves en tu suscripción a Azure usando las siguientes llamadas a la API.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["Para un par de HA"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["Para un solo nodo"^]: `GET /azure/vsa/metadata/vaults`
...
+
Para un par HA: `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
Para un solo nodo: `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. Para un par de HA usa https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["esta llamada a la API"^]:
+
...
.. Para un sistema de un solo nodo, usa https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["esta llamada a la API"^]:
+
...
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Prepárate para usar los flujos de trabajo de la API Cloud Volumes ONTAP"^].
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["Conoce las API REST de gestión de ONTAP"^].
