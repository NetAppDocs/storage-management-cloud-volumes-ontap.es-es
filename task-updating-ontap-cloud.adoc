...
. En la ficha de agregados correspondiente, haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] y luego selecciona *Ver detalles del agregado*.
+
...
. En el sistema, haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] y luego haz clic en *Update Cloud Volumes ONTAP*.
