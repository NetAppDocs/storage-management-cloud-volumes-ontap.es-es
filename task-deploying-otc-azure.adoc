...
+
Esta opción solo está disponible para determinados tipos de máquinas virtuales. Para saber qué tipos de máquinas virtuales son compatibles, consulta link:link:reference-configs-azure.html#ha-pairs["Configuraciones admitidas por licencia para pares HA"].
...
+
link:link:reference-configs-azure.html#ha-pairs["Obtenga más información sobre las configuraciones compatibles en Azure"^].
