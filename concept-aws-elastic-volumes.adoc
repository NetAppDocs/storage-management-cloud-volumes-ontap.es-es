...
Estos permisos se incluyen en https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["las políticas proporcionadas por NetApp"^]
...
+
https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["Aprenda a configurar la replicación de datos"^]
