...
---
= Conoce la velocidad de escritura en Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Si usas un sistema de un solo nodo, Cloud Volumes ONTAP admite alta velocidad de escritura con todos los tipos de instancia.
...
link:reference-configs-aws.html["Obtenga más información sobre las instancias de Amazon EC2 que admite Cloud Volumes ONTAP"].
...
Si usas un sistema de un solo nodo, Cloud Volumes ONTAP admite alta velocidad de escritura con todos los tipos de VM.

Si utilizas un par HA, Cloud Volumes ONTAP admite alta velocidad de escritura con varios tipos de VM, empezando desde la versión 9.8. Ve a la link:reference-configs-azure.html["Notas de la versión de Cloud Volumes ONTAP"] para ver los tipos de VM que admiten alta velocidad de escritura.
...
Si usas un sistema de un solo nodo, Cloud Volumes ONTAP admite alta velocidad de escritura con todos los tipos de máquinas.

Si utilizas un par de alta disponibilidad (HA), Cloud Volumes ONTAP admite alta velocidad de escritura con varios tipos de instancias de VM, a partir de la versión 9.13.0. Ve a link:reference-configs-gcp.html#supported-configurations-by-license["Notas de la versión de Cloud Volumes ONTAP"^] para ver los tipos de instancias de VM que admiten alta velocidad de escritura.

link:reference-configs-gcp.html["Obtenga más información sobre los tipos de máquinas de Google Cloud que admite Cloud Volumes ONTAP"^].
