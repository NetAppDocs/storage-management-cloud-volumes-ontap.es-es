...
https://docs.netapp.com/us-en/console-setup-admin/task-configuring-proxy.html#enable-a-proxy-on-a-connector["Aprenda a habilitar el tráfico API directo en el agente de la consola"^]
