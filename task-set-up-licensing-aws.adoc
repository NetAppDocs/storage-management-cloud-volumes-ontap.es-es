...
== Configuración de la facturación preferida para el listado independiente de AWS

Si tienes una suscripción independiente de AWS vinculada a tu cuenta de AWS, puedes pagar Cloud Volumes ONTAP a través de esa suscripción. Si también tienes suscripciones a NetApp Intelligent Services (NIS), puedes pagar tus servicios de datos a través del paquete asociado con la suscripción NIS. Para las suscripciones existentes, NetApp recomienda cambiar al enfoque de suscripción independiente para gestionar mejor los costes de tu uso de Cloud Volumes ONTAP.

.Acerca de esta tarea
Si eres un cliente existente con suscripciones NIS asociadas a la cuenta de AWS, NetApp recomienda cambiar al enfoque de suscripción independiente para una mejor gestión de los costes de tu uso de Cloud Volumes ONTAP. Este es el proceso completo:
...
. (Si procede) Convierte tu paquete Professional en un paquete Essentials y establece la preferencia de facturación. Consulta https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-capacity-licenses.html#change-charging-methods["Cambiar los métodos de cobro de las licencias de capacidad"^] para obtener información sobre cómo convertir tu paquete Professional en un paquete Essentials.
. Continúa facturando servicios de datos a través de tu suscripción NIS.


.Pasos
. En el panel izquierdo de la NetApp Console, selecciona *Administración > Licenses and subscriptions > Billing preferences > Cloud Volumes ONTAP*.
. En la pestaña AWS, selecciona la suscripción independiente y haz clic en el icono de opciones image:screenshot_gallery_options.gif["icono de kebab"].
. En la ventana Editar configuración, selecciona el número de suscripción del listado independiente en el campo *Credenciales de cuenta de AWS*.
. Haz clic en *Configure*. Puedes ver la suscripción como la opción preferida para tu facturación de Cloud Volumes ONTAP en AWS.
. Al desplegar un nuevo sistema Cloud Volumes ONTAP, selecciona el paquete Essentials para facturar a través de la suscripción independiente. Para obtener más información, consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-aws.html["Implementa Cloud Volumes ONTAP con Quick create en AWS"^].


Repite los mismos pasos para la suscripción NIS en la pestaña *Servicios de datos* para usar la suscripción NIS para tus servicios de datos. Al implementar un nuevo sistema Cloud Volumes ONTAP, selecciona el paquete Professional para facturar a través de la suscripción NIS.
...
. https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Agregue su cuenta del sitio de soporte de NetApp a la consola"^]
+
...
+
Para poder utilizar tu licencia con Cloud Volumes ONTAP, esta debe estar disponible en la consola. Si es necesario, puedes link:https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-data-services-licenses.html#add-a-license["agregar manualmente la licencia a la consola"^].
...
TIP: Puedes gestionar las suscripciones de AWS Marketplace asociadas a tus cuentas de AWS desde la página Configuración > Credenciales. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Aprenda a administrar sus cuentas y suscripciones de AWS"^]
...
Selecciona la oferta Freemium para utilizar Cloud Volumes ONTAP de forma gratuita con hasta 500 GiB de capacidad asignada. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#free-trials["Obtenga más información sobre la oferta Freemium"^].
...
.. En la página *Detalles y credenciales*, haga clic en *Editar credenciales > Agregar suscripción* y luego siga las instrucciones para suscribirse a la oferta de pago por uso en AWS Marketplace.
+
No se te cobrará a través de la suscripción del marketplace a menos que superes los 500 GiB de capacidad asignada, momento en el que el sistema se convierte automáticamente en el link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Paquete esencial"^].
