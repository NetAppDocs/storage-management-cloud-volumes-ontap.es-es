...
[role="lead"]
NetApp ofrece dos opciones para implementar Cloud Volumes ONTAP en Azure.  Cloud Volumes ONTAP tradicionalmente se basa en la consola de NetApp para la implementación y la orquestación.  A partir de Cloud Volumes ONTAP 9.16.1, puede aprovechar la implementación directa del mercado de Azure, un proceso optimizado que brinda acceso a un conjunto limitado, pero aún potente, de características y opciones de Cloud Volumes ONTAP .
...
[cols="3*"]
|===
|  | Mercado de Azure | Consola de NetApp 
...
| *Capacidades de orquestación* | No disponible | Disponible a través de NetApp Console, según el tipo de licencia 
...
* https://docs.netapp.com/us-en/bluexp-family/index.html["Documentación de la consola de NetApp"^]
