...
| Amplia gama de tipos de máquinas virtuales. link:reference-configs-azure.html["Configuraciones admitidas en Azure"] 
...
| *Tipo de disco compatible* | Discos administrados SSD v2 Premium | Un soporte más amplio. link:reference-configs-azure.html#azure-storage-for-user-data["Tipos de disco compatibles en Azure"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["Documentación de la NetApp Console"^]
