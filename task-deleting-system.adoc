...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["Obtenga más información sobre la instancia de Clasificación de datos"^].
...
.. En la parte superior derecha de la consola, haz clic en el icono image:icon-action.png["Un icono que muestra tres puntos horizontales para acciones adicionales"] y selecciona *Eliminar*.
