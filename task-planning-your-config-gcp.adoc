...
El límite de capacidad bruta para un sistema Cloud Volumes ONTAP está vinculado a la licencia.  Límites adicionales impactan el tamaño de los agregados y los volúmenes.  Debe tener en cuenta estos límites al planificar su configuración.
...
--
Tamaño del disco GCP:: Debe elegir un tamaño de disco inicial cuando implemente un sistema Cloud Volumes ONTAP .  Después de eso, puede dejar que la consola de NetApp administre la capacidad de un sistema por usted, pero si desea crear agregados usted mismo, tenga en cuenta lo siguiente:
+
--
