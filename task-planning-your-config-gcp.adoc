...
Tipo de máquina:: Consulta los tipos de máquina compatibles en link:reference-configs-gcp.html["Notas de la versión de Cloud Volumes ONTAP"^] y luego revisa los detalles de Google sobre cada tipo de máquina compatible. Adapta los requisitos de tu carga de trabajo al número de vCPU y memoria del tipo de máquina. Ten en cuenta que cada núcleo de CPU aumenta el rendimiento de red.
+
--
...
* link:reference-configs-gcp.html#google-cloud-single-node["Ver los discos predeterminados para los datos del sistema Cloud Volumes ONTAP en Google Cloud"].
...
TIP: El agente Console también necesita un disco del sistema. https://docs.netapp.com/us-en/console-setup-admin/reference-connector-default-config.html["Ver detalles sobre la configuración predeterminada del agente de la consola"^].
