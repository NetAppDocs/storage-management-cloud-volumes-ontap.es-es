...
+
Consulta https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-azure-download-digest-file.html["Descargar el archivo de resumen de imagen de Azure"^] para más información.
