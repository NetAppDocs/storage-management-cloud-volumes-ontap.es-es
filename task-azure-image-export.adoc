...
----
+
La URL sigue un formato estándar. Para la automatización, puedes obtener la cadena URL como se muestra a continuación. Como alternativa, puedes usar el comando Azure CLI `az` para obtener la URL. Ejemplo de URL: +https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
