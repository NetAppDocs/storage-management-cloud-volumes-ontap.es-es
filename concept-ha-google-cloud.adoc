...
--
Actualizaciones:: Cuando actualiza Cloud Volumes ONTAP, la consola de NetApp también actualiza la instancia del mediador según sea necesario.
...
+
Sus datos son transaccionales consistentes sin pérdida de datos.
