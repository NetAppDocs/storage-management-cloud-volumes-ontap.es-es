...
* Para Azure, no necesitará hacer nada siempre que la consola de NetApp tenga los permisos necesarios. <<Requisitos para organizar en niveles datos inactivos en el almacenamiento de blobs de Azure,Más información>> .
...
[role="quick-margin-para"]
La consola de NetApp le solicita que elija una política de niveles cuando crea, modifica o replica un volumen.
