...
---
= Segrega el tráfico de SnapMirror en Cloud Volumes ONTAP en Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
----
.. Guarda la dirección IP privada. Esta dirección IP, <new_added_nic_primary_addr>, se utiliza para crear un LIF intercluster en <<step-second,dominio de difusión y LIF intercluster para la nueva NIC>>.
...
== [[paso-segundo]]Paso 2: crear un nuevo espacio IP, dominio de difusión y LIF intercluster para la nueva NIC
