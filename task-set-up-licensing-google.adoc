...
. https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Agregue su cuenta del sitio de soporte de NetApp a la NetApp Console"^]
+
...
+
Tu licencia debe estar disponible en la consola antes de que puedas usarla con Cloud Volumes ONTAP. Si es necesario, puedes link:https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-data-services-licenses.html#add-a-license["agregar manualmente la licencia a la consola"].
...
TIP: Puedes gestionar las suscripciones a Google Cloud Marketplace asociadas a tus cuentas desde la página Configuración > Credenciales. https://docs.netapp.com/us-en/console-setup-admin/task-adding-gcp-accounts.html["Aprenda a administrar sus credenciales y suscripciones de Google Cloud"^]
