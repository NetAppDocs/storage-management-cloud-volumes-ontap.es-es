...
Selecciona la oferta Freemium para utilizar Cloud Volumes ONTAP de forma gratuita con hasta 500 GiB de capacidad asignada. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Obtenga más información sobre la oferta Freemium"^].
...
+
No se te cobrará a través de la suscripción del marketplace a menos que superes los 500 GiB de capacidad asignada, momento en el que el sistema se convierte automáticamente en el link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["Paquete esencial"^].
...
+
Tu licencia debe estar disponible en la consola antes de que puedas usarla con Cloud Volumes ONTAP. Si es necesario, puedes link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["agregar manualmente la licencia a la consola"].
...
TIP: Puedes gestionar las suscripciones de Azure Marketplace asociadas a tus cuentas de Azure desde la página Configuración > Credenciales. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Aprenda a administrar sus cuentas y suscripciones de Azure"^]
