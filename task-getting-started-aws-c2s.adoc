...
summary: Puedes implementar Cloud Volumes ONTAP en entornos de AWS Secret Cloud y Top Secret Cloud. Las regiones de AWS Secret Cloud y Top Secret Cloud son regiones cerradas específicas de la Comunidad de Inteligencia de EE. UU. Las instrucciones de esta página solo aplican a los usuarios de las regiones de AWS Secret Cloud y Top Secret Cloud. 
---
...
+
Para obtener más información sobre cómo funciona el modo privado, consulta link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode["el modo de implementación privada en la consola"^].
