...
+
--
Al iniciar instancias de Cloud Volumes ONTAP , debe elegir el tamaño de disco predeterminado para los agregados.  La consola de NetApp utiliza este tamaño de disco para el agregado inicial y para cualquier agregado adicional que cree cuando utilice la opción de aprovisionamiento simple.  Puede crear agregados que utilicen un tamaño de disco diferente del predeterminadolink:task-create-aggregates.html["utilizando la opción de asignación avanzada"] .
