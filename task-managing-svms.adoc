...
---
= Máquinas virtuales de almacenamiento Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Una máquina virtual de almacenamiento (SVM) es una máquina virtual que se ejecuta dentro de ONTAP y que proporciona servicios de almacenamiento y datos a tus clientes. Quizá la conozcas como _SVM_ o _vserver_. Cloud Volumes ONTAP está configurado con una máquina virtual de almacenamiento por defecto, pero algunas configuraciones admiten máquinas virtuales de almacenamiento adicionales.
